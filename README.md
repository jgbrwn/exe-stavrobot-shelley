...
- the actual optional Shelley "Stavrobot mode" likely belongs in the official Shelley repo itself, with this repo later orchestrating fetch/build/update of that mode when requested
